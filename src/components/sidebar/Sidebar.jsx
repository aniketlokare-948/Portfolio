...
import logo from '../images/Aniket.png';
...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/aniketlokare-948'
    },
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/aniket-lokare-53494023a'
    },
   
    {
      component: instagram,
      href: 'https://www.instagram.com/aniket_lokare1296/'
    },
    {
      component: gmail,
      href: 'lokareaniket1155@gmail.com'
    }
  ];
  ...
  return (
    <div className='sidebar'>
      ...
      <div className='topHashtag'>#computerscience</div>
      ...
      >
        <img src={logo} alt="Profile" className='my-img' />
      </motion.div>
